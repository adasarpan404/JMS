...
exports.maidSignUp = exports.maidLogin = exports.logout = exports.signup = exports.login = void 0;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('Sucess', 'Login in with Maid Account is successful');
              window.setTimeout(function () {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee5(name, email, phonenumber, password, passwordConfirm) {
    var res;
